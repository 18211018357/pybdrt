...
import sys
import random
from pybdrt.avatica.types import TypeHelper
from pybdrt.avatica.errors import ProgrammingError, InternalError
from pybdrt.avatica.proto import common_pb2
...
class Cursor(object):
    ...
    def execute(self, operation, parameters=None):
        ...
        if parameters is None:
            ...
            results = self._connection.prepare_and_execute(
                #self._connection._id, self._id,
                self._connection._id, 123456,
