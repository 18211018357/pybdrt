...
from .types import BDRT_TYPE_MAP

class BdrtCompiler(SQLCompiler):
    ...
    def visit_label(self, label,
        ...
        if render_label_only or render_label_with_as:
            ...
            # Hierarchical label is not supported in Bdrt
...
class BdrtIdentifierPreparer(IdentifierPreparer):
    # Bdrt is case sensitive, temp hack to turn off name quoting
    def __init__(self, dialect, initial_quote='',
                 final_quote=None, escape_quote='', omit_schema=False):
        super(BdrtIdentifierPreparer, self).__init__(dialect, initial_quote, final_quote, escape_quote, omit_schema)


class BdrtDialect(default.DefaultDialect):
    name = 'bdrt'
    driver = 'bdrt'

    preparer = BdrtIdentifierPreparer
    ...
    def __init__(self, **kwargs):
        super(BdrtDialect, self).__init__(self, **kwargs)

    @classmethod
    def dbapi(cls):
        return __import__('pybdrt')
    ...
    def _map_column_type(self, column):
        ...
        if tpe_NAME.startswith('VARCHAR'):
            ...
            args = (tpe_size,)
            tpe = BDRT_TYPE_MAP['VARCHAR']
        elif tpe_NAME == 'DECIMAL':
            digit_size = column['decimal_DIGITS']
            args = (digit_size,)
            tpe = BDRT_TYPE_MAP['DECIMAL']
        else:
            args = ()
            tpe = BDRT_TYPE_MAP[tpe_NAME]
        column_tpe = tpe(*args)
        return {
